...
// Screen calibration
// use these values to calibrate digitizer
#define DIGITIZER_HEIGHT        992
#define DIGITIZER_WIDTH         480

// Use Ticker Tape
#define CONFIG_MACH_TICKERTAPE

#ifdef CONFIG_MACH_TICKERTAPE
/* For Ticker Screen and Soft Button Area */
